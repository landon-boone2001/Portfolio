...
// BUG- Currently, the make test will return the first test, but then output error  free(): double free detected in tcache 2. I have no clue
// what is going on with it, I have tried about everything to fix it to no avail. Individually, each test case works outside of the test file.
// Landon Boone - CS 202
// 9-27-22
